...
import { TrendingDown, RefreshCw, ArrowLeftRight, IndianRupee, Truck, ShoppingBag } from "lucide-react";
...
// 10-minute cache — analytics are expensive
const QUERY_OPTS = { staleTime: 10 * 60 * 1000 } as const;
      ...
      <Card>
        <CardHeader className="px-5 pt-5 pb-2">
          ...
          <p className="text-xs text-muted-foreground">
            Customer paid (half of Delhivery charge) vs what we absorbed
          </p>
        </CardHeader>
        <CardContent className="px-2 pb-4">
          {isLoading ? (
