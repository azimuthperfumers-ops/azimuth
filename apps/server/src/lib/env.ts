...
const envSchema = z.object({
  ...
  // Email template IDs (MSG91 → Email → Templates)
  MSG91_EMAIL_TEMPLATE_ORDER_PLACED: z.string().optional(),
  MSG91_EMAIL_TEMPLATE_ORDER_DELIVERED: z.string().optional(),
  MSG91_EMAIL_TEMPLATE_REFUND: z.string().optional(),
  MSG91_EMAIL_TEMPLATE_VERIFY: z.string().optional(),
